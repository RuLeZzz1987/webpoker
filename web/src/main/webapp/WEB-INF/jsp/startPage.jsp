		...
		<form action="start" method="POST" name="form">
			<table>
				<tr>
					...
					<td>
						<p><strong>Enter bankroll</strong><br>
							<input type="number" name="bankroll" min="500" max="100000" step="50" value="1000"><br>
						</p>
					</td>
					<td>
						<p><strong>Choose 1st bet value</strong><br>
							<input type="number" name="bet" min="5" max="100" step="5" value="10">
						</p>
					</td>
				</tr>	
			</table>
